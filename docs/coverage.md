...
**Generated deterministically by `tools/coverage.py` from `sources.yml` (ledger updated 2026-09-14) plus a filesystem scan. Do not edit by hand.**
...
| **fear-vr** | external reference | LithTech Jupiter EX | native-injector | T3 | R1 · native re-entry | 17 | 24 | 0 | 19 | 2026-09-19 | 🟥 source changed | 7F / 3P / 0S / 1NR / 2— |
...
| **gothic2-vr** | external reference | ZenGin via OpenGothic (Gothic II: Night of the Raven), Android baseline from Solessfir's OpenGothic port | source-port | — | — | 18 | 3826 | 2640 | 365 | 2026-09-19 | 🟩 current | 0F / 0P / 2S / 10NR / 1— |
...
| **MGS5VR** | external reference | FOX (Metal Gear Solid V) | native-injector | — | — | 9 | 188 | 95 | 56 | 2026-09-19 | 🟥 source changed | 0F / 6P / 3S / 4NR / 0— |
...
| **QuestSam** | external reference | Serious Engine (Serious Sam Classic TFE and TSE) | source-port | — | — | 18 | 1038 | 758 | 15 | 2026-09-19 | 🟩 current | 0F / 0P / 1S / 11NR / 1— |
...
| **sm64coopdx-VR-Standalone-Physics-based** | external reference | Super Mario 64 decompilation via sm64coopdx | source-port | — | — | 18 | 4674 | 3608 | 50 | 2026-09-19 | 🟩 current | 0F / 0P / 1S / 11NR / 1— |
...
| **SystemReShock-UEVR-Plugin** | external reference | Unreal Engine 4.27.2 (System Shock Remake) | framework-companion | — | — | 18 | 4912 | 4850 | 14 | 2026-09-15 | 🟩 current | 0F / 7P / 3S / 0NR / 3— |
...
| **fear-vr** | 2026-08-29 | `tree:7437c5bc33a9688d` | `tree:bc77c8cf5547ea23` | `—` | 🟥 source changed | unknown | MIT |
...
| **GEVR** | 2026-09-19 | `tree:34023fff9cb9b47f` | `tree:34023fff9cb9b47f` | `b87b808c4d391dddeeb28d3feb525cec43185b78` | 🟩 current | https://github.com/no6969el/GEVR | MIT |
| **GloomhavenVR** | 2026-09-19 | `tree:2366adfe88bed33d` | `tree:2366adfe88bed33d` | `377d26ec4f28b8bd5f40a8f364365e23372e21cb` | 🟩 current | https://github.com/McFredward/GloomhavenVR | GPL-3.0 |
...
| **gothic2-vr** | 2026-09-19 | `tree:c4d445619ccd8fa5` | `tree:c4d445619ccd8fa5` | `d74ccbfcc23c0efa7f2b23ccbc4649183c6f2413` | 🟩 current | https://github.com/dubrovskiy-yevhen-stakelogic/gothic2-vr | MIT |
...
| **KCD1VR** | 2026-09-19 | `tree:e41980f85dd64f18` | `tree:e41980f85dd64f18` | `dcd0b1d8413493a5603f2eace5ae45314b929b7c` | 🟩 current | https://github.com/farmerarmor/KCD1VR | MIT |
| **KHARVOX** | 2026-09-14 | `tree:5704ee580c726593` | `tree:5704ee580c726593` | `e2e15d603ae7bfa45b05424b88207179e903670e` | 🟩 current | https://github.com/CactusVRStudios/KHARVOX | MIT; upstream and bundled dependencies retain their own notices |
...
| **l4d2vr** | 2026-08-27 | `tree:0a633263d8116124` | `tree:510b1f22ac72c821` | `—` | 🟥 source changed | unknown | unknown |
...
| **MGS5VR** | 2026-09-14 | `tree:95e3921c54d08c9b` | `tree:4e75ea50ebe1fc5b` | `a51c4b9660f18addc71f06208fcd357d5ad58b15` | 🟥 source changed | https://github.com/nikamigaming-create/MGS5VR | MIT; bundled dependencies retain their own notices |
...
| **QuestSam** | 2026-09-19 | `tree:4889e5b786b3e8e0` | `tree:4889e5b786b3e8e0` | `42c97b0e83d6cca18430d3f3b72a350acb37aed4` | 🟩 current | https://github.com/maranone/QuestSam | unknown - no LICENSE file found |
...
| **sm64coopdx-VR-Standalone-Physics-based** | 2026-09-19 | `tree:c1c0def7d304784f` | `tree:c1c0def7d304784f` | `36e693af5a9df88bf27f29282f2e30c375f6a9d1` | 🟩 current | https://github.com/fulldivegames/sm64coopdx-VR-Standalone-Physics-based | unknown - no LICENSE file found |
...
| **SystemReShock-UEVR-Plugin** | 2026-09-17 | `tree:8e5dc79ae4dab1bc` | `tree:8e5dc79ae4dab1bc` | `3c69f183872f2838b0c38cca38bc9816c00f1f2d` | 🟩 current | https://github.com/gwizdek/SystemReShock-UEVR-Plugin | unknown |
...
| **ThiefVR** | 2026-09-19 | `tree:50d73b0477f1f019` | `tree:50d73b0477f1f019` | `2d7e867f75cb3314cab856f9fec866543bf59aee` | 🟩 current | https://github.com/farmerarmor/ThiefVR | GPL-2.0 |
...
| **TrackManiaForeverOpenXR** | 2026-09-19 | `tree:7376f42fe45e2819` | `tree:7376f42fe45e2819` | `57e449c002d79e4174c0f3398dc4dd97c535f00f` | 🟩 current | https://github.com/jiink/TrackManiaForeverOpenXR | MIT |
...
| **UVOSuit** | 2026-09-19 | `tree:1e9628e93af9ee8f` | `tree:1e9628e93af9ee8f` | `fad4769b9851cd28ffddb1d8dd85a777fa6a0328` | 🟩 current | https://github.com/Wamasoet/UVOSuit | MIT |
...
- `OBVR 0.1.3 56559 3 2026-09-07T09-29Z gWxLrl3z` — Nexus Mods download of an Oblivion VR mod: three files, 0.5 MB, no source, no git history. The directory name is the Nexus download slug. Nothing to read without running it; re-classify if a source repository appears.
- `Detroit-Become-Human-VR-Mod` — Eleven files, 2.5 MB, MIT-licensed but ZERO source files - binaries and configuration only. Same class as the other release-artifact directories here; the source it was built from is not in this checkout.
...
| `packaging_deploy` | 🟥 not reviewed | `—` | — |
| `re_discovery` | 🟥 not reviewed | `—` | — |
| `source_integration` | 🟧 skimmed | `AUTHOR` | REGISTERED 2026-09-19, README ONLY. 52 source files - the smallest of the four. Notable for building BOTH a Quest APK and a PCVRCarnage.exe from one gameplay/menu codebase, which is the cheapest available example of one VR layer serving standalone and PCVR targets. LICENCE UNRESOLVED. |
...
| Area | Review | Evidence | Note |
|---|---|---|---|
| `stereo` | 🟨 partial | `SOURCE` | CODE READ 2026-09-17 (src/EngineCamera.cpp): the native-stereo claim is now SOURCE, not AUTHOR - `using Stereo = void(__cdecl*)(float*,bool,float,float)` is the game's own HD3D entry point the mod calls, and addresses are rebased for ASLR against a pinned executable. Confirmed in code alongside it: DirectionWorld(DirectionConfig::Source) for the three-way targeting, interactionScreen/scopeScreen for the context-driven virtual screen, lockVerticalCamera, and controllerHideArms - a fourth independent hide-the-arms data point. Also a ring-buffer scene trace and four named per-eye fixes behind toggles (skyFix, effectsFix, eyeViewFix, instanceFix). HARVESTED: its bounds rule to 14 #widen-vs-cull (enlarge only FINITE bounds, keep the native centre; and their cell lookup has no callback for query type 10, so one path never reaches the hook) and its both-locomotion-axes warning to 03. ORIGINAL README REVIEW: checkout verified at upstream (0/0). HIGH VALUE and unusual - it drives the GAME'S OWN native AMD HD3D stereo renderer, so BOTH EYES RENDER IN THE SAME GAME FRAME. That is a shipped-stereo-path activation case, not an injected second view, and it is the closest thing in this ledger to 18 #engine-native-xr on a non-UE engine. Ships its own per-eye capture - F8 dumps both-eye images plus a camera trace, F10 is a rolling stereo-frame recorder - which corroborates 09 #eye-image-delta-review from a shipping mod. Code not read; src/EngineCamera.cpp (808 lines) is the bulk, and PairHistory.h / SharedPair.h / PairCapture.h suggest explicit pair tracking. |
...
| `packaging_deploy` | 🟥 not reviewed | `—` | — |
| `re_discovery` | 🟥 not reviewed | `—` | — |
| `source_integration` | 🟧 skimmed | `AUTHOR` | REGISTERED 2026-09-19, STRUCTURE ONLY. 1,210 source files, 341 MB. Unity is not a priority-fleet engine and the corpus already has managed-plugin coverage, so this is registered for completeness rather than queued. Revisit only if a Unity target enters the fleet. |
...
| `render_hazards` | 🟥 not reviewed | `—` | — |
| `ui_hud` | 🟥 not reviewed | `—` | — |
| `hands_interaction` | 🟧 skimmed | `AUTHOR` | Physical melee, parrying, two-handed grips requiring both hands to deal damage, using OpenGothic's native damage and reaction rules - ch02 #two-handed-support territory, driven through the host engine's own systems rather than replacing them. Not read. |
| `input_locomotion` | 🟥 not reviewed | `—` | — |
| `performance` | 🟥 not reviewed | `—` | — |
| `audio` | 🟥 not reviewed | `—` | — |
| `packaging_deploy` | 🟥 not reviewed | `—` | — |
| `re_discovery` | 🟥 not reviewed | `—` | — |
| `source_integration` | 🟧 skimmed | `AUTHOR` | REGISTERED 2026-09-19, README ONLY. The largest and most developed of the four Quest ports: 2,798 source files, tracked hands, physical combat, stereoscopic world, running ON the headset. Built on OpenGothic (an engine recreation of ZenGin) - so the VR work is a layer on somebody else's reimplementation, which is the pattern all four share. Author calls it a very early alpha. |
...
| Area | Review | Evidence | Note |
|---|---|---|---|
| `stereo` | 🟨 partial | `SOURCE` | AerWeaponPoseCache and AerCameraPairCache key first/second phase state by entity or stage and pair serial, not worker TLS. SnapTurnStereoPolicy plus OpenXRBootstrap consumers track per-cached-eye turn generation. ch14 #pair-cache-identity. README recommends alternate-eye; native replay remains experimental, not a demonstrated upgrade. |
| `xr_lifecycle` | 🟨 partial | `SOURCE` | Native input preservation, pair-completion guards and typed retirement ownership inspected. DeferredMemoryFreeQueue.complete trusts caller CPU/GPU completion; standalone queue tests cannot establish GPU safety. PresentWaitOwnership is a policy helper with no production consumer found, not evidence that every submit path is balanced. ch10 #replay-input-retirement. |
| `xr_input` | 🟥 not reviewed | `—` | — |
| `camera_tracking` | 🟨 partial | `SOURCE` | Pair-cache identity and camera history validators inspected. No universal matrix-layout or live target camera proof inferred from plausible values. |
| `render_hazards` | 🟨 partial | `SOURCE` | NativeFinalReplay preserves storage-attachment inputs before the real pass, not from processed eye-zero output. VirtualTextureAppend validates counts and caps copy to destination capacity while retaining source; ch14 #bounded-streaming-append. Actual standalone helper tests include 4582+3719 into 8192 slots: 3610 appended,109 deferred. Engine backlog continuation and original failure episodes remain AUTHOR. |
| `ui_hud` | 🟥 not reviewed | `—` | — |
| `hands_interaction` | 🟨 partial | `SOURCE` | Bounded cross-worker weapon pose cache inspected; no weapon feel, collision or physical-interaction acceptance. |
| `input_locomotion` | 🟨 partial | `SOURCE` | Snap generation and cached-eye compensation policy/consumers reviewed; not a headset snap-turn verdict. |
| `performance` | 🟥 not reviewed | `—` | — |
| `audio` | 🟥 not reviewed | `—` | — |
| `packaging_deploy` | 🟧 skimmed | `SOURCE` | README and version-sensitive byte-gated virtual-texture patch reviewed; no deployment performed. Local latest commit says Beta 0.9 while README header still says Beta 0.5; no maturity inferred from either label. |
| `re_discovery` | 🟨 partial | `SOURCE` | VirtualTextureGuard exact-byte/RVA gates inspected as implementation, not independently validated DOOM binary layout. Donor fail-fast process termination is not a universal recovery recommendation. |
| `source_integration` | 🟥 not reviewed | `—` | — |
...
| Area | Review | Evidence | Note |
|---|---|---|---|
| `stereo` | 🟨 partial | `SOURCE` | scene_capture.cpp tracks eye-copy packets through deferred recording, FinishCommandList and actual ExecuteCommandList before pair eligibility. Recorded and executed masks differ; execution is queue insertion, NOT GPU completion. Harvest ch09 #deferred-eye-execution. stereo.cpp eyeImageRegion supplies tested corroboration of existing #subimage-fov-pair. September 14 standalone audit includes rounded pixel/ray agreement at even and odd extents and invalid-input controls; no game/GPU/headset test. Full audit and fleet relevance: briefs/2026-09-14-new-mods-harvest.md. |
| `xr_lifecycle` | 🟨 partial | `SOURCE` | Read capture/mailbox transaction and epoch ownership, plus architecture documentation. Not a full runtime lifecycle review; headset compatibility remains the author's claim. |
| `xr_input` | 🟥 not reviewed | `—` | — |
| `camera_tracking` | 🟨 partial | `SOURCE` | Rendered versus requested FOV, exact integer crop/FOV pairing and same-source eye metadata; no shipping-target RE or canting acceptance here. |
| `render_hazards` | 🟨 partial | `SOURCE` | Deferred execution provenance and stale-generation rejection. Donor capture saves one RTV binding, not a generic MRT state envelope; do not copy it as a universal state saver. |
| `ui_hud` | 🟨 partial | `SOURCE` | fitWristPanel checks all four corners in both eye frusta, moves to readable depth then toward anchor without shrinking physical size; ch04 #binocular-panel-fit. No headset readability test. |
| `hands_interaction` | 🟨 partial | `SOURCE` | solveArm keeps hinge orientation separate from downstream corrective twist channels; body-clearance constraint changes elbow-circle position instead of stretching lengths. ch02 #hinge-versus-twist. FOX indices, axes and per-arm coefficients do not establish FarCry2 skin weights. |
| `input_locomotion` | 🟥 not reviewed | `—` | — |
| `performance` | 🟧 skimmed | `SOURCE` | Architecture describes a nonblocking capture mailbox. No frame-time measurements or claimed performance improvement harvested. |
| `audio` | 🟥 not reviewed | `—` | — |
| `packaging_deploy` | 🟧 skimmed | `SOURCE` | README/CMake inspected: x64 dinput8 injector and build-specific target checks. No full installer or deployment audit. |
| `re_discovery` | 🟧 skimmed | `SOURCE` | Read source/build targeting and arm basis interpretation; native binary addresses were not independently checked. |
| `source_integration` | 🟥 not reviewed | `—` | — |
...
#### MonsterDeadWood-Analyzer-Bible

| Area | Review | Evidence | Note |
|---|---|---|---|
| `stereo` | 🟨 partial | `SOURCE` | Same-frame metadata checker hardened with missing/duplicate/empty controls. Neither distinct hashes nor synthetic fixtures establish geometric stereo or headset acceptance. |
| `xr_lifecycle` | — no entry — | — | — |
| `xr_input` | — no entry — | — | — |
| `camera_tracking` | — no entry — | — | — |
| `render_hazards` | — no entry — | — | — |
...
| `audio` | — no entry — | — | — |
| `packaging_deploy` | — no entry — | — | — |
| `re_discovery` | 🟨 partial | `SOURCE` | Inspected postflight/contracts, numerical mapping, checker and merge scripts. Integrated research-receipts.md, new validated intake/offline tools and synthetic verifier controls. Donor case-study outcomes remain unverified; original corpus preserved. |
| `source_integration` | — no entry — | — | — |
...
| `xr_input` | 🟥 not reviewed | `—` | — |
| `camera_tracking` | 🟥 not reviewed | `—` | — |
| `render_hazards` | 🟨 partial | `SOURCE` | READ 2026-09-18 (d3d12_history.cpp) and 2026-09-19 (d3d12_frame_synthesizer.cpp, 3,692 lines). d3d12_history distilled to ch14 #history-slot-identity, ch19 #gpu-resource-identity, META-016 and FAIL-PERF-023: a ring slot index is a LOCATION, not an identity (four-field capture ticket plus a consumer lease, both serials validated on every read); and there is a third state between finished and running - UNTRACKABLE - covering the window between ExecuteCommandLists and a SUCCESSFUL Signal, where wait_for_idle refuses rather than waiting on a fence that will never advance. THE SYNTHESIZER, distilled to ch14 #packed-stereo-seam + STR-020 + FAIL-STR-066: when both eyes are packed into one optical-flow input it inserts a 64-pixel gutter AND rounds the per-eye stride up to the estimator's block size (8 for FidelityFX, 4 for the NVIDIA path), because a gutter that is wide but unaligned still lets one estimation cell span two eyes. It also offers a separate-surfaces path where the stride is zero, and refuses with E_INVALIDARG when the gutter would push the texture past D3D12's dimension limit. Separately, same_view_layout will not synthesise between two captures unless view count, per-view array slice, rect offsets and dimensions all match. Three optical-flow backends are wired: FidelityFX, NVIDIA, and a game-motion path that uses the engine's own vectors instead of estimating flow. DRED SetMarker calls are gated behind the same switch as the flight recorder, so a normal run records no diagnostic GPU commands. STILL UNREAD: openxr_layer.cpp (4,851 lines), where the presenter pacing lives. OPENXR_LAYER.CPP NOW READ BEYOND PACING (2026-09-19), distilled to ch09 #what-pipelining-breaks + FAIL-XR-030 and ch06 #dont-measure-their-opinion-of-you + META-019. (a) Holding a frame past its call revokes a guarantee the application relied on - a composition layer names an XrSpace, and at pipeline depth above zero a queued submission can still name one the application destroys; the runtime rejects it, the failure LATCHES, and every later frame call fails for the session. Seen as the session freezing on RECENTRE, because that is when an application rebuilds its reference space. Their own line is the rule: 'upstream never needed this because the application waited for the queue to empty inside xrEndFrame; it does not any more'. (b) xrEndFrame::displayTime is NOT an identity token for the preceding xrWaitFrame - UEVR's Native Stereo Fix deliberately submits an older pipelined render state - so the layer falls back to call order when exactly one wait is outstanding and returns nothing when ambiguous. META-016 in a fourth subsystem. (c) A fence you own cannot prove a FOREIGN command list is done: OptiScaler's DLSS list 'is owned and submitted by the game', so private snapshot slots are retained rather than freed - a fourth case beside ch19's untrackable state, where the work is not yours to measure at all. (d) THE FEEDBACK LOOP: predictedDisplayPeriod is partly SteamVR's judgement of the CALLER, so counting it as evidence of throttling closed a loop - warm-up hitch widens the period, the widened period promotes the presenter, the promotion hitches harder. Measured: UEVR promoted three frames after first synthesis on two 20us waits, SteamVR reporting 33.3 then 22.2 ms against an 11.1 ms baseline, GPU hung 4 ms later. Only a wait that ACTUALLY BLOCKED counts as evidence. |
| `ui_hud` | 🟥 not reviewed | `—` | — |
| `hands_interaction` | 🟥 not reviewed | `—` | — |
| `input_locomotion` | 🟥 not reviewed | `—` | — |
...
| Area | Review | Evidence | Note |
|---|---|---|---|
| `stereo` | 🟨 partial | `SOURCE` | CODE READ 2026-09-17 (src/Src/XRStereoRender.cpp): the flat-fusion recipe is now SOURCE - vFov = 2*atan(max(\|tan(angleUp)\|,\|tan(angleDown)\|)) builds a symmetric SUPERSET of the eye's asymmetric fov which is then cropped, corroborating 09 #symmetric-base-decomposition with the arithmetic written out (max, not average, is what makes the crop only ever remove pixels you had). Re-entry seam is CSystem::RenderEnd, the once-per-frame present point that 'every rendered frame passes exactly once'; the second eye pass must call RenderBegin to reset engine state. Ships vr_fullrate_limit, a clamp that stops cleanly after N pairs - harvested to TEST-024 with its flush-on-write breadcrumb logging. ORIGINAL README REVIEW: EXTERNAL PRIOR ART FOR THE FLEET'S OWN PreyVR - same game, same engine, independent author, so read it as a second witness rather than a donor. Author states pre-alpha but hardware-verified on Quest 2 over Meta Horizon Link. Deliberately parked at the FLAT-FUSION rung rather than geometric stereo (that work is on an unmerged stage-4 branch): the flat game frame is placed at each eye's OPTICAL CENTRE IN TAN-ANGLE SPACE under the headset's native FOV, which the author names as the thing that makes the two eyes fuse. A clean R4-shaped waypoint with an explicit recipe. XRStereoRender.cpp (265 lines) not read. |
...
| `source_integration` | 🟧 skimmed | `SOURCE` | MEASURED 2026-09-17: mock_runtime.cpp is 513 lines exporting 42 OpenXR entry points, a second independent count beside BioShock-Trilogy-VR's 39 - now cited in 09 #substitute-runtime as a planning bracket. SHIPS ITS OWN MOCK OPENXR RUNTIME in mockxr/ (mock_runtime.cpp, mock_loader_interfaces.h, CMakeLists.txt). That makes a THIRD independent substitute runtime in this corpus, alongside BioShock-Trilogy-VR's xrsim and the fleet's own xr-sim - strong corroboration that 09 #substitute-runtime is a thing everyone building headless VR arrives at. Its surface and fidelity were not assessed. |
...
| `packaging_deploy` | 🟥 not reviewed | `—` | — |
| `re_discovery` | 🟥 not reviewed | `—` | — |
| `source_integration` | 🟧 skimmed | `AUTHOR` | REGISTERED 2026-09-19, README ONLY. 758 source files. VR port for standalone Quest against Croteam's released Serious Engine source; game data supplied by the owner, not bundled. LICENCE UNRESOLVED - no LICENSE file present, so treat the code as unusable until that is settled. |
...
| `hands_interaction` | 🟨 partial | `SOURCE` | READ 2026-09-19: PropFrobInfo, then shock2vr/src/interaction.rs (2,088 lines) and vr_support::solve_two_hand_pose. Distilled to ch02 #two-handed-support, ch08 #one-interaction-two-presentations, and the #grab-detection-layer context finding. TWO-HAND GRIP IS OVER-DETERMINED - twelve tracked degrees of freedom onto a rigid six - and this is the corpus's clearest statement of one resolution: ONE HAND IS PRIMARY and its anchor lands exactly on its palm; the SUPPORT HAND ONLY AIMS, supplying the direction the authored anchor-to-anchor vector is rotated onto; TWIST IS INHERITED from the primary orientation rather than solved, because aligning one vector leaves roll free; and there is NO SCALE SOLVE, refused in the docstring. Both degeneracies are guarded - coincident hands return the PREVIOUS rotation, antiparallel hands pick a deterministic twist axis (primary local X, falling back to local Z past a 0.9 parallel threshold, then orthogonalised). Compare Meta's IsdkGrabFreeTransformer (symmetric) and VRExpansionPlugin's ESecondaryGripType (per-grip setting): three frameworks, three resolutions, and choosing none is the error. ALSO: interaction is one trait with two implementations, VR and flat, both emitting the same VirtualHandEffect vocabulary, with every VR-specific method DEFAULTED so the flat controller costs no code. Its own comment records the trap that design leaves: StoreItem and DropItem look interchangeable but only DropItem dispatches the drop message, so a caller storing a held item must dispatch it manually or the world-model restore is skipped. Also unread but noted: resolve_hand_climb feeds collision-resolved motion back into the tracking reference, and the climb pass runs BEFORE movement because its result IS the movement. |
| `input_locomotion` | — no entry — | — | — |
...
#### sm64coopdx-VR-Standalone-Physics-based
...
| `packaging_deploy` | 🟥 not reviewed | `—` | — |
| `re_discovery` | 🟥 not reviewed | `—` | — |
| `source_integration` | 🟧 skimmed | `AUTHOR` | REGISTERED 2026-09-19, STRUCTURE ONLY. 3,640 source files, 202 MB. Multiplayer VR on a decompilation base. The 'physics-based' in the name is the interesting part if it means physical interaction rather than animation-driven, but nothing is confirmed. LICENCE UNRESOLVED (the SM64 decompilation lineage makes this worth care, not just paperwork). |
...
| Area | Review | Evidence | Note |
|---|---|---|---|
| `stereo` | 🟨 partial | `SOURCE` | UEVR COMPANION PLUGIN, the Mode 3 case study for ch18 #companion-plugin-scope and now the basis of docs/uevr-route.md. UEVR owns stereo/projection/submission/lifecycle entirely; NONE of this plugin is stereo work. Re-reviewed 2026-09-17 at 3c69f18 (checkout is AT upstream, 0/0). Corrected: first-party source is ~6,050 lines (dllmain 2871, plugin 2177, vr_body 533, plugin_utils 470), not the ~2,900 previously recorded. Author reports a UEVR-level stereo desync after level change / death / main menu, worked around by toggling Native Stereo in the UEVR overlay. [AUTHOR] |
| `xr_lifecycle` | — no entry — | — | — |
| `xr_input` | 🟧 skimmed | `AUTHOR` | Full controller map documented per context (general / MFD / cyberspace) with distinct bindings per game state. Requires the host game's controller bindings reset to defaults. Menu binding depends on the VR runtime and can collide with Virtual Desktop's own binding. |
| `camera_tracking` | 🟨 partial | `SOURCE` | HARVESTED -> UEVR-002. VR policy is a state machine over pawn class x game context (CINEMATIC, PAUSE_MENU, MFD, BOOTING_UP, CRASHING, INTERACTABLE, MAIN_MENU, INTRO_DRONE, INTRO_LAPTOP, PSEUDOSPACE, cyberspace), not a global VR mode. Camera ownership is per ANIMATION MONTAGE: montages are classified in a table (starting/ending/single) and the saved camera rotation is restored on montage end. Declarative camera binding lives in uobjecthook/camera_state.json - bound by object path to an existing ArrowComponent AnimCameraPosition plus a Z offset. |
| `render_hazards` | — no entry — | — | — |
| `ui_hud` | 🟨 partial | `SOURCE` | HARVESTED -> UEVR-003 + FAIL-HUD-016. Reparents the game's own UMG widgets into 3D: saves the original canvas panel slot, removes the widget from its parent (layout mangles otherwise), binds it to a WidgetComponent, then rebuilds the slot from saved attributes so ONE widget instance serves both the flat MFD and the VR item selector. Host HUD-curve option must be 0 or reparented hotbar slots land wrong - a correctness precondition, not comfort. WidgetInteractionComponent laser collides with the player's own arm meshes; fixed with a dedicated trace channel (disabling arm collision outright is recorded as a FAILED attempt). Minimap via WidgetComponent caused massive UObject creation when looked at - left disabled, recorded as a dead end. |
| `hands_interaction` | 🟨 partial | `SOURCE` | HARVESTED -> HAND-018 + FAIL-HAND-052. vr_body.cpp: a custom A_BP_VRBody_C made resident by hard-referencing it from a PAK-shipped modified ArmsMesh AnimBP; VR actor moved to the bottom of the collision capsule; HMDComponent tracks the UEVR camera offset against its own VROrigin. Physical grab/holster/access-card/lever interaction. The author lists four design-invariant breaks as known issues at once - theft through container geometry, shooting through doors, seeing over geometry while physically crouched in a crouch-height tunnel, two-handed poses misaligned - which is the evidence behind HAND-018. |
| `input_locomotion` | 🟨 partial | `AUTHOR` | A body-anchored gesture vocabulary, read from the README control tables (code not traced): ear (calibrate, flashlight), shoulder (holster, backpack), inner wrist (MFD, game menu), waist (access card). Note the anchor scarcity - MFD and game menu share the inner-wrist location and are disambiguated by BUTTON (grip vs thumb), not by place. Physical crouch; run on left thumb; laser pointer as the fallback for any failed physical interaction. |
| `performance` | 🟧 skimmed | `AUTHOR` | Author recommends DLSS Swapper to a transformer-model DLSS and names profiles J/K as the sharpest that are not too heavy. Not measured here. |
| `audio` | — no entry — | — | — |
| `packaging_deploy` | 🟨 partial | `SOURCE` | HARVESTED -> FAIL-PACK-019 + uevr-route.md. TWO coupled artifacts with nothing enforcing the coupling: the plugin DLL and PAK asset packages must be the same version, and the README has to instruct users in bold to re-copy PAKs after every update. The PAKs are also load-bearing for code (see hands_interaction). Build-specific: no Steam demo, no GOG. Defender removes the DLL on profile import. Profile sites carry differing versions. Inject at MAIN MENU so the mod can write host game options. |
| `re_discovery` | 🟧 skimmed | `SOURCE` | No pattern scanning: works through UE reflection and a GENERATED UObject SDK. Notes that the SDK's StaticClass() returns the live UClass - the same UObject the UEVR API uses. Has a pre-native hook able to SKIP the original call, and a self-guarding lazy init that returns once the class is loaded and hooked (UE loads classes on demand). Generated SDK internals not read. |
| `source_integration` | 🟨 partial | `SOURCE` | HARVESTED -> UEVR-001. A UEVR profile has a DECLARATIVE layer that most people write code for: uobjecthook/<hash>_mc_state.json attaches any component to a motion controller by object path with offsets and a permanent flag (the headlamp SpotLightComponent is attached to hand 1 at 0,-10,40 with no code); <hash>_props.json overrides properties by path (an idle animation silenced with RateScale 0); camera_state.json binds the camera. MEASURED: of ~6,050 first-party lines the UEVR API surface actually used is tiny - a few param() calls, uevr::Plugin, uevr::API::UStruct - everything else is written against the game's own UObject graph. A UEVR companion is UE game-code modding that runs inside UEVR, not framework extension. |
...
| `performance` | 🟥 not reviewed | `—` | — |
| `audio` | 🟥 not reviewed | `—` | — |
| `packaging_deploy` | 🟧 skimmed | `AUTHOR` | Queries the headset's recommended render resolution before each launch rather than baking it - cheap and worth copying. |
| `re_discovery` | 🟥 not reviewed | `—` | — |
| `source_integration` | 🟥 not reviewed | `—` | — |
...
| Area | Review | Evidence | Note |
|---|---|---|---|
| `stereo` | 🟨 partial | `SOURCE` | Native Northstar-hosted plugin. scene_reentry.cpp has bounded nested-pass, latch/job and epilogue experiments; release keeps same-frame re-entry disabled. KNOWN-ISSUES reports a roughly 129-double-frame deadlock (AUTHOR, not reproduced). Harvest ch17 #reentry-endurance: short isolation burst != sustained viability; TLS scope does not include async worker uploads. |
| `xr_lifecycle` | 🟥 not reviewed | `—` | — |
| `xr_input` | 🟥 not reviewed | `—` | — |
| `camera_tracking` | 🟨 partial | `SOURCE` | world_rect_gate.h separates tiny auxiliary viewports from plausible world extents. Unknown target remains permissive, tested explicitly. ch09 #world-rect-provenance: size filter is not ownership proof. Source-reported 32x32 startup episode remains AUTHOR. |
| `render_hazards` | 🟨 partial | `SOURCE` | Read temporal_lever.cpp: distinguish current/history blend polarity, real convar from command, and snapshot current value before an experiment. Existing per-eye-history method retained; no duplicate recipe or blanket TAA-disable recommendation. |
| `ui_hud` | 🟧 skimmed | `AUTHOR` | README/known issues describe incomplete overlay behaviour. No stable UI implementation recommendation harvested. |
| `hands_interaction` | 🟥 not reviewed | `—` | — |
| `input_locomotion` | 🟥 not reviewed | `—` | — |
| `performance` | 🟥 not reviewed | `—` | — |
| `audio` | 🟥 not reviewed | `—` | — |
| `packaging_deploy` | 🟧 skimmed | `SOURCE` | README and known issues identify v0.1.1 alpha and Northstar host. No installation, game launch or wearer compatibility test. |
| `re_discovery` | 🟨 partial | `SOURCE` | Re-entry experiment guards and scoped pass provenance read; source comments describing job-wait runtime diagnoses are AUTHOR without reviewed raw receipts. Do not import latch offsets or experimental writes to another target. |
| `source_integration` | 🟥 not reviewed | `—` | — |

#### TrackManiaForeverOpenXR

| Area | Review | Evidence | Note |
|---|---|---|---|
| `stereo` | 🟧 skimmed | `AUTHOR` | REGISTERED 2026-09-19, STRUCTURE ONLY. Thirteen source files and 0.4 MB - the smallest injector in the ledger. Its value is as a MINIMAL reference: whatever it does is the irreducible core of an OpenXR injection, with nothing else in the way. Ten minutes, low expectations. |
| `xr_lifecycle` | — no entry — | — | — |
| `xr_input` | 🟥 not reviewed | `—` | — |
| `camera_tracking` | 🟥 not reviewed | `—` | — |
| `render_hazards` | 🟥 not reviewed | `—` | — |
...
| `hands_interaction` | 🟥 not reviewed | `—` | — |
| `input_locomotion` | 🟥 not reviewed | `—` | — |
| `performance` | 🟧 skimmed | `AUTHOR` | C++20, described as high-performance; nothing measured. |
| `audio` | 🟥 not reviewed | `—` | — |
| `packaging_deploy` | 🟥 not reviewed | `—` | — |
| `re_discovery` | 🟥 not reviewed | `—` | — |
| `source_integration` | 🟥 not reviewed | `—` | — |
