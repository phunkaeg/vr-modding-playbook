...
| **PreyVR** | 2026-08-28 | `tree:ea9020b75685cf9d` | `tree:409ea98e369f762c` | `—` | 🟥 source changed | internal | internal-unreleased |
...
| **PreyVR** | active mod | CryEngine (Arkane) | re-owned | D3D11 | x64 | pre-T1 | — | unproven | 1896 | 271 | 2026-09-05 | 🟥 source changed | 2F / 3P / 1S / 0NR / 7— |
