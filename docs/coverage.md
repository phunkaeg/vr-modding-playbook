...
| **PreyVR** | 2026-08-28 | `tree:ea9020b75685cf9d` | `tree:a4375aeb608dc809` | `—` | 🟥 source changed | internal | internal-unreleased |
...
| **ss2vr-work** | 2026-08-28 | `tree:4d9e7c06edd1a483` | `tree:d7e2d9cbe117d65b` | `—` | 🟥 source changed | internal | internal-unreleased |
...
|---|---|---|---|---|---|---|---|---|--:|--:|---|---|---|
| **ss2vr-work** | active mod | Dark / KEX | hybrid-re+script | D3D11 | x64 | T3 | — | R2 · per-draw replay | 4103 | 357 | 2026-09-05 | 🟥 source changed | 9F / 3P / 0S / 0NR / 1— |
