...
| **PreyVR** | 2026-08-28 | `tree:ea9020b75685cf9d` | `tree:68ddfc387f5f981b` | `—` | 🟥 source changed | internal | internal-unreleased |
...
| **PreyVR** | active mod | CryEngine (Arkane) | re-owned | D3D11 | x64 | pre-T1 | — | unproven | 2066 | 346 | 2026-09-07 | 🟥 source changed | 2F / 3P / 1S / 0NR / 7— |
